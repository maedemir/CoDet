...
Finally we managed to reach  high-precision models for both datasets(with over 92% precision for CT dataset  and over 96% precision for CXR dataset using VGG16) 
# About the datasets
